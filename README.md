...
## Defacement 101: Find the Suspects (Picture 1.1 – 1.4)
...
## Defacement Step 102: Expose the Target (Picture 1.5-1.6) 
...
## Defacement Step 103: Look through the contents (Picture 1.7)
...
## Defacement Step 106: Get the dest_ip (Picture 2.1) 
