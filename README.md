...
Defacement 101: Find the Suspects (Pictures 1.1 – 1.4) <br /> 
What is the likely IPv4 address of someone from the Po1s0n1vy group scanning imreallynotbatman.com for web application vulnerabilities? <br />
...
Defacement Step 102: Expose the Target (Pictures 1.5-1.6)  <br /> 
What company created the web vulnerability scanner used by Po1s0n1vy? Type the company name. <br /> 
...
- <b> Pictures 1.5					Pictures 1.6
    

Defacement Step 103: Look through the contents (Pictures 1.7) <br /> 
What content management system is imreallynotbatman.com likely using?  <br /> 
...
Defacement Step 104: Find the target’s .exe file (Pictures 1.8 – 1.9) <br /> 
What is the name of the file that defaced the imreallynotbatman.com website? Please submit only the file name with the extension. <br /> 
Answer guidance: For example, "notepad.exe" or "favicon.ico" <br /> 
...
Defacement Step 105: Target’s FQDN (Pictures 2.0-2.1)  <br /> 
...
Defacement Step 106: Get the dest_ip  (Pictures 2.3)  <br /> 
...
Defacement Step 108: Brute-force attacks leave a Network trail (Pictures 2.2)  <br /> 
...
Defacement Step 109: Filenames (Pictures 2.3) <br /> 
...
Defacement Step 110: Crowd Source your way to a solution (Pictures 2.4-2.5) <br /> 
What is the MD5 hash of the executable uploaded? <br /> 
...
Defacement Step 111: Scan the IPv4 (Pictures 2.6) <br /> 
...
Defacement Step 112: Let's find Steve to buy him a beer (Pictures 2.7-2.8) <br /> 
...
- <b>  	Pictures 2.7			Pictures 2.8



Defacement Step 114: When you are lost, return to basics (Pictures 2.9) <br /> 
...
Defacement Step 115: Google is your best friend (Pictures 3.0-3.1) <br /> 
...
- - <b> 				Pictures 3.0					 Pictures 3.1			
 
Defacement Step 116: Rex expressions (Pictures 3.2-3.3) <br /> 
...
- <b> Answer: Batman
- <b> Pictures 3.2				Pictures 3.3
 

Defacement Step 117: The Means (Pictures 3.4-3.8) <br /> 
...
Defacement Step 118: Round 2 (Pictures 3.8) <br /> 
...
Defacement Step 119: More than one way to do it (Pictures 3.9) <br /> 
